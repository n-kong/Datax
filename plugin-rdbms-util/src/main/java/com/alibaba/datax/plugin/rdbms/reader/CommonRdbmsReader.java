...
import com.alibaba.datax.plugin.rdbms.util.RdbmsStringUtil;
...
import static com.alibaba.datax.plugin.rdbms.reader.util.FtpUtils.processFtp;
...
public class CommonRdbmsReader {
    ...
    public static class Job {
        ...
        public void preCheck(Configuration originalConfig, DataBaseType dataBaseType) {
            ...
            for (int i = 0, len = connList.size(); i < len; i++) {
                ...
                PreCheckTask t =
                    new PreCheckTask(username, password, connConf, dataBaseType, splitPK);
                taskList.add(t);
            }
    ...
    public static class Task {
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            //ob10的处理
            if (this.jdbcUrl
                .startsWith(com.alibaba.datax.plugin.rdbms.writer.Constant.OB10_SPLIT_STRING) &&
                this.dataBaseType == DataBaseType.MySql) {
                String[] ss = this.jdbcUrl.split(
        ...
        public void startRead(Configuration readerSliceConfig,
            ...
            LOG.info("Begin to read record by Sql: [{}\n] {}.",
                querySql, basicMsg);
            PerfRecord queryPerfRecord =
                new PerfRecord(taskGroupId, taskId, PerfRecord.PHASE.SQL_QUERY);
            ...
            try {
                ...
                throw RdbmsException
                    .asQueryException(this.dataBaseType, e, querySql, table, username);
            } finally {
        ...
        protected Record buildRecord(RecordSender recordSender, ResultSet rs,
            ...
            String flg = readerSliceConfig.getString(Key.IMAGE_FLG, "").toLowerCase();
            List flgs = Arrays.asList(flg.split(",", -1));
            try {
                for (int i = 1; i <= columnNumber; i++) {

                    if (flgs.contains(metaData.getColumnName(i).toLowerCase())) {
                        String ftpUrl = rs.getString(i);
                        record.addColumn(new StringColumn(ftpUrl));
                        String base64 = processFtp(ftpUrl);
                    ...
                    switch (metaData.getColumnType(i)) {
                        ...
                        case Types.LONGNVARCHAR:
                            ...
                            record
                                .addColumn(new StringColumn(RdbmsStringUtil.replaceBlank(rawData)));
                            break;

                        case Types.CLOB:
                        case Types.NCLOB:
                            record.addColumn(
                                new StringColumn(RdbmsStringUtil.replaceBlank(rs.getString(i))));
                            break;
                        ...
                        case Types.TIMESTAMP:
                            ...
                            if (StringUtils.isNotEmpty(str) && str.contains(".")) {
                                record.addColumn(
                                    new StringColumn(str.substring(0, str.indexOf("."))));
                            } else {
                        ...
                        case Types.LONGVARBINARY:
                            ...
                            //record.addColumn(org.apache.commons.net.util.Base64.encodeBase64String(rs.getBytes(i)));
                                //new StringColumn(Base64.byteArrayToBase64(rs.getBytes(i))));
                        ...
                        case Types.NULL:
                            ...
                            record.addColumn(
                                new StringColumn(RdbmsStringUtil.replaceBlank(stringData)));
                            break;
